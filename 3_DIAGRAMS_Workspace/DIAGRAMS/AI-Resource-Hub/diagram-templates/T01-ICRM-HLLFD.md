# Template T01: ICRM-HLLFD
## High Level Logical Flow Diagram

**Template ID:** T01
**Diagram Type:** High Level Logical Flow Diagram
**Target Audience:** Technical / Architecture teams
**Version:** 1.0
**Created:** 2026-04-07
...
Standard upstream/downstream integration map showing all systems that connect to the application, numbered integration flows, and domain color-coding.
...
Type: High Level Logical Flow Diagram
Template: T01
