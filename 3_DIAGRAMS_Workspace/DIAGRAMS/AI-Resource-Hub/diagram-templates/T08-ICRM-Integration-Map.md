# Template T08: ICRM-Integration-Map
## Integration / Interface Map

**Template ID:** T08
**Diagram Type:** Integration / Interface Map
...
Interface and API connectivity diagram. Shows all integration points, protocols (REST, SOAP, MQ, etc.), and direction of data flow.
...
Type: Integration / Interface Map
Template: T08
