# Template T03: ICRM-C4-Container
...
Shows the internal technology building blocks (containers) within the application boundary. Each container shows technology stack.
