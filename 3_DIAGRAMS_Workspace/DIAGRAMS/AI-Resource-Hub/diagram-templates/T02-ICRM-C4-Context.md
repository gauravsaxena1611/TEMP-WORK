# Template T02: ICRM-C4-Context
## C4 Level 1 — System Context Diagram

**Template ID:** T02
**Diagram Type:** C4 Level 1 — System Context Diagram
...
Shows the application as a single box in the centre with all external users, systems, and third-party services around it. Grey boxes for external systems.
...
Type: C4 Level 1 — System Context Diagram
Template: T02
