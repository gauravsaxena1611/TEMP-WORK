...
## [](#whats-the-background-behind-the-c4-model)What’s the background behind the C4 model?
...
## [](#whats-the-inspiration-behind-the-c4-model)What’s the inspiration behind the C4 model?
...
## [](#who-is-using-c4)Who is using C4?

Simon has personally taught the C4 model to 10,000+ people in ~40 countries; with conference talks, videos, books, and articles reaching many more than this. Other people are also teaching, speaking, and writing about the C4 model, plus it’s been integrated into a number of tools. Here are some case studies:
...
## [](#isnt-the-c4-model-a-step-backwards-why-are-you-reinventing-uml-why-not-just-use-uml)Isn’t the C4 model a step backwards? Why are you reinventing UML? Why not just use UML?
...
## [](#the-c4-model-vs-uml-archimate-and-sysml)The C4 model vs UML, ArchiMate and SysML?
...
## [](#why-doesnt-the-c4-model-cover-business-processes-workflows-state-machines-domain-models-data-models-etc)Why doesn’t the C4 model cover business processes, workflows, state machines, domain models, data models, etc?
...
## [](#can-we-combine-c4-and-arc42)Can we combine C4 and arc42?
...
## [](#does-the-c4-model-imply-a-design-process-or-team-structure)Does the C4 model imply a design process or team structure?
...
## [](#using-c4-to-describe-libraries-frameworks-and-sdks)Using C4 to describe libraries, frameworks and SDKs?
...
## [](#is-the-c4-model-universally-applicable)Is the C4 model universally applicable?
...
## [](#does-the-c4-model-scale)Does the C4 model scale?

The example diagrams conveniently consist of a small number of boxes and arrows, but you might be asking how the C4 model can be used with real-world software systems, where you have 600 components rather than 6. The answer is that the tooling you choose can either help or hinder you.
...
This diagram works at the moment, but will quickly become cluttered as we add more services. As an alternative approach, rather than creating a single diagram showing 8 services, we could create 8 diagrams that each focus on a single service, showing the nearest afferent (inbound) and efferent (outbound) dependencies:

[![](/images/scale-2.png)](/images/scale-2.png)

[![](/images/scale-3.png)](/images/scale-3.png)

[![](/images/scale-4.png)](/images/scale-4.png)
