...
## [](#stage-1---monolithic-architectural-style)Stage 1 - monolithic architectural style
...
## [](#stage-2---microservices-architectural-style)Stage 2 - microservices architectural style
...
To answer this question, we’ll refer to [Microservices](https://martinfowler.com/articles/microservices.html) written by James Lewis and Martin Fowler:
...
## [](#stage-3---conways-law)Stage 3 - Conway’s Law

As our company grows, and moves from startup to scaleup, we start looking at ways to optimise delivery, and decide to look at [Conway’s Law](https://en.wikipedia.org/wiki/Conway%27s_law) as a way to do this. In summary, we decide to split our single engineering team into a number of teams, the result of which is that each service will be owned by a separate team:
